...
/**
 Extraction mode (Internal usage only).
 */
typedef NS_ENUM(NSUInteger, FPhiExtractionMode) {
...
/**
 Liveness mode (Internal usage only).
 */
typedef NS_ENUM(NSUInteger, FPhiLivenessMode) {
