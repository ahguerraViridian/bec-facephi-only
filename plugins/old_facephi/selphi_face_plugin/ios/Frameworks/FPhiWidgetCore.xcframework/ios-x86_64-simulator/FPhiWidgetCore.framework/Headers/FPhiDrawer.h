 ...
 */
@property FPhiExtractionMode widgetMode;

/*
 * LivenessMode instanced by host
 */
@property FPhiLivenessMode livenessMode;
 ...
 */
-(id) init:(FPhiWidgetResourceManager *)rm :(FPhiExtractionMode)widgetMode :(FPhiLivenessMode)livenessMode :(bool)qrFlag :(bool)tutorialFlag;
 ...
 */
-(bool)isValidExtractionResult:(CGRect)face :(CGPoint)leftEye :(CGPoint)rightEye extractionMode:(FPhiExtractionMode)extractionMode;
